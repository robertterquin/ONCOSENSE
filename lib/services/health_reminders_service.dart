...
class HealthRemindersService {
  ...
  Future<List<HealthReminder>> getActiveReminders({
    String? category,
    int limit = DataLimits.healthRemindersLimit,
  }) async {
    try {
  ...
  Future<List<HealthReminder>> getRemindersToShow({int count = DataLimits.healthRemindersToShow, bool forceRefresh = false}) async {
    try {
  ...
  List<HealthReminder> _getReliableHealthReminders() {
    return [
      ...
      HealthReminder(
        ...
        frequencyHours: ReminderFrequency.everyThreeHours,
        priority: 5,
      ...
      HealthReminder(
        ...
        color: '03A9F4',
        category: ReminderCategory.hydration,
        frequencyHours: ReminderFrequency.everyFourHours,
        priority: 4,
      ...
      HealthReminder(
        ...
        frequencyHours: ReminderFrequency.everyTwoHours,
        priority: 5,
      ...
      HealthReminder(
        ...
        color: '66BB6A',
        category: ReminderCategory.exercise,
        frequencyHours: ReminderFrequency.daily,
        priority: 4,
      ...
      HealthReminder(
        ...
        frequencyHours: ReminderFrequency.weekly,
        priority: 5,
      ...
      HealthReminder(
        ...
        frequencyHours: ReminderFrequency.everySixHours,
        priority: 4,
      ...
      HealthReminder(
        ...
        frequencyHours: ReminderFrequency.everyTwelveHours,
        priority: 4,
      ...
      HealthReminder(
        ...
        frequencyHours: ReminderFrequency.monthly,
        priority: 5,
      ...
      HealthReminder(
        ...
        color: '8BC34A',
        category: ReminderCategory.exercise,
        frequencyHours: ReminderFrequency.hourly,
        priority: 4,
      ...
      HealthReminder(
        ...
        color: 'FF6F00',
        category: ReminderCategory.nutrition,
        frequencyHours: ReminderFrequency.everyTwoDays,
        priority: 4,
      ...
      HealthReminder(
        ...
        color: '0097A7',
        category: ReminderCategory.hydration,
        frequencyHours: ReminderFrequency.everyEightHours,
        priority: 3,
      ...
      HealthReminder(
        ...
        color: '1976D2',
        category: ReminderCategory.mentalHealth,
        frequencyHours: ReminderFrequency.everyThreeDays,
        priority: 4,
        source: 'National Institute on Aging',
      ),
      HealthReminder(
